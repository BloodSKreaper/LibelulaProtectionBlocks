...
public class YamlUtils {
    ...
    public static ConfigurationSection getSection(BlockVector3 bv) {
        ConfigurationSection result
    ...
    public static BlockVector3 getBlockVector(ConfigurationSection cs) {
        BlockVector3 bv = null;
        if (cs != null) {
            bv = BlockVector3.at(cs.getInt("x"), cs.getInt("y"), cs.getInt("z"));
        }
        return bv;
    }
}
