...
public final class Main extends JavaPlugin {
	...
	public final ParticleManager pam;
	public WorldGuardManager wg;
					...
					try {
						if (!wg.isWorldGuardActive()) {
							...
							if (!setupEconomy()) {
								...
								sendMessage(getServer().getConsoleSender(), tm.getText("vault-plugin-linked"));
								if (getConfig().getBoolean("shop.enable")) {
									sh.initialize();
									sendMessage(getServer().getConsoleSender(), tm.getText("shop_enabled"));
								}
							}
						}
